...
# Объявляем переменную hello и присваиваем ей значение - объект строку
hello = "Привет, пацаны!"

# Объявляем переменную hello2 и присваиваем ей пустой объект nil
# С помощью ключевого слова Руби - nil
hello2 = nil

# Присваиваем этой переменной другое значение - новую строку
hello2 = "Привет, девчонки!"
