...
# Запускаем цикл, в котором будет спрашивать у пользователя новую строку для
...
# который формирует строку типа 2014_12_27. Для этого применяются специальные
...
# Строка-разделитель для записей
separator = "----------------------------"
